  ...
  return (
    <div className="w-full h-[100vh]">
      ...
      <div className="absolute w-full h-full bg-gradient-to-t from-black to-transparent  top-0  flex-col items-center justify-center  px-4">
        <h1 className="text-white text-4xl md:text-5xl font-bold text-center mt-[26rem] w-[480px] m-auto">
          {title}
        </h1>
        {type && (
          <p className="text-sm mt-4 text-center text-green-800 bg-[#00000090] px-6 py-4 rounded-full w-[480px] m-auto">
